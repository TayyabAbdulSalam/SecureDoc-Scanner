...
def upload_file():
    ...
    uploaded_file_path = askopenfilename(filetypes=[("Image Files", "*.png *.jpg *.jpeg *.bmp *.gif")])
    if uploaded_file_path:
        ...
        window.destroy()
        os.system("python3 Imageuploaded.py")
    else:
...
button_1 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=upload_file,  # Open file dialog
    relief="flat"
)
button_1.place(
    x=54.7958984375,
...
canvas.create_text(
    ...
    148.7994384765625,
    anchor="nw",
    text="Simply upload or drag and drop your image here:",
    fill="#FFFFFF",
    font=("Inter", 33 * -1)
)
